...
points_letters = {1: ['а', 'в', 'е', 'ё', 'и', 'н', 'о', 'р', 'с', 'т'],
                  2: ['д', 'к', 'л', 'м', 'п', 'у'],
                  3: ['б', 'г', 'ь', 'я'],
                  4: ['й', 'ы'],
                  5: ['ж', 'з', 'х', 'ц', 'ч'],
                  8: ['ф', 'ш', 'э', 'ю'],
                  10: ['щ'],
                  15: ['ъ']}  # словарь в удобно читаемом виде
letters_points = {}
for k, v in points_letters.items():  # создание словаря вида {'а': 1, ...}
    for a in v:
        letters_points[a] = k
...
def scrabble(word):
    ...
    :return points:
    """
    points = sum([letters_points[letter] for letter in word])  # суммирование по списку очков каждой буквы
    return points
